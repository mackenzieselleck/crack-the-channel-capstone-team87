...
|**Project**|Crack the Channel - Interactve QKD (BB84) Learning Platorm|
|**Prepared by**|Byreddy Srilekha – Business Analyst|
|**Document Status**|Sprint 1 - Inital Requirements Baseline|
|**Purpose**|This is an inital Sprint 1 baseline and will be refned following user<br>research, beginner-learning observatons, UX fndings, technical feasibility<br>work, and Product Owner feedback|
...
The project brief explicitly identifies the working web platform, Eve mode/live feedback, beginnerfocused UX/content, and documentation/evaluation materials as key deliverables. 
...
The proposal also states that real IBM Quantum hardware is a nice-to-have rather than a dependency, and that a Qiskit-compatible simulator may be used. 
...
Detailed authentication behaviour remains subject to scope and Product Owner confirmation because production-grade user management is explicitly out of scope. 

#### **FR-02 - Team Page** 

#### **Requirement:** 

The system shall provide a team page containing the agreed project/team information. 
...
The system shall introduce the BB84 protocol before requiring the learner to perform the interactive exchange. 
...
**I want to** understand what I will learn and do in the platform 

**So that** I know what to expect before starting the simulation. 
...
- ✓ The learner is introduced to the Alice and Bob concept before the relevant interaction. 

✓ The introduction uses plain language suitable for a learner with little or no prior quantum knowledge. 
...
✓ Given the learner is introduced to the BB84 exchange, Alice and Bob are clearly identified as the sender and receiver. 

✓ The learner is given a simple explanation of each role before performing the relevant steps. 

✓ The interface visually distinguishes Alice and Bob. 

✓ The learner can explain the basic purpose of each role after the introduction. 
...
✓ Given the learner reaches an unfamiliar BB84 concept, the concept is explained before the learner must use it. 
...
- ✓ Given the learner selects/enters Bob's role, Bob is clearly identified. 

- ✓ The learner can complete the required receiver-side steps. 
...
**So that** I can connect my actions with the resulting key-exchange outcome. 

#### **Acceptance Criteria:** 

✓ Given the BB84 exchange has completed, the learner is shown the relevant exchange outcome. 

- ✓ Relevant and discarded information are distinguishable where applicable. 

- ✓ The outcome is accompanied by a beginner-friendly explanation. 

- ✓ Technical results are not presented without sufficient explanatory context. 

- ✓ The learner can connect the outcome to the actions performed during the exchange. 
...
✓ Given the learner has completed or reached the required BB84 stage, they can enter the Eve scenario. 

- ✓ Eve is clearly identified as the eavesdropper. 

- ✓ The learner is told what Eve is doing before the interaction occurs. 

- ✓ Eve's interaction affects the exchange rather than being purely descriptive. 
...
- ✓ The change is visually distinguishable from the normal exchange. 

- ✓ The learner receives an explanation of what caused the change. 

- ✓ The experience demonstrates the security principle through interaction rather than text alone. 
...
**I want to** receive an explanation of technical terms such as QBER in plain language 
...
|**Epic**|**User Stories**|**Supportng Requirements**|
|---|---|---|
|Access & Orientaton|US-01,US-02|FR-01,FR-02|
|BB84 Foundatons|US-03,US-04,US-05|FR-03,LR-01–LR-05|
|Interactve Exchange|US-06–US-09|FR-04–FR-07|
|Eve & Security|US-10–US-13|FR-08,FR-09|
|LearningFeedback|US-14–US-16|FR-10,FR-11,LR-01–LR-06|
|UX|Cross-cutng|UX-01–UX-07|
|TechnicalQuality|Cross-cutng|NFR-01–NFR-06|
...
**Then** the platform shall display the resulting error-rate/QBER information **And** explain what the change means for the security of the communication. 
...
|**Project Outcome**|**Requirements**|**User Stories**|**Validaton**|
|---|---|---|---|
|Beginner understands<br>BB84|FR-03, LR-01–LR-05|US-03–US-05|Learning evaluaton|
|Learner performs<br>exchange|FR-04–FR-07|US-06–US-09|Functonal testng|
|Learner understands<br>Alice/Bob|FR-05, FR-06|US-07, US-08|Usability testng|
|Learner understands<br>Eve|FR-08|US-10, US-11|Functonal + usability<br>testng|
|Learner understands<br>QBER|FR-09, FR-10|US-12, US-13|Usability/evaluaton|
|Beginner-friendly<br>experience|LR + UX requirements|US-03–US-16|Usability testng|



|Working browser<br>platorm|FR + NFR<br>requirements|US-01, US-06|Functonal testng|
|---|---|---|---|
|Client-readyhandover|NFR-05|Cross-cutng|Documentaton review|
