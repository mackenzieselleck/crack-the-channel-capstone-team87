...
|**Document Status**|<sup>Sprint 1: Final Requirements & User Stories Baseline</sup><br>Revision: 3.0|
|**Purpose**|This document establishes the final Sprint 1 requirements and user<br>stories baseline, incorporating refined user research, beginner-learning<br>observations, UX findings, technical feasibility work, IBM Quantum<br>learning insights, and Product Owner/client direction. The finalised<br>requirements identify the functionality and learning experience to be<br>taken forward into Sprint 2|
...
These additional features were developed by the team in response to the client's direction to think creatively about learner engagement, together with learner research, IBM Quantum learning observations, and the team's analysis of how to support continued learning. They remain subordinate to the core educational objective and are prioritised as Should Have requirements where implementation feasibility is relevant. 
...
**Client direction** included encouraging the team to think creatively about the learning experience and explore AI and mechanisms that provide meaningful reasons for learners to return. The team translated 

this direction into proposed AI learning support, Daily Quantum Challenges, progressive levels, XP, achievements/badges, milestone feedback, and continued learning. 
...
accomplishments. **Priority:** Should Have 
...
The platform should provide meaningful opportunities for learners to return, including continuing learning activities, Daily Challenges, progression goals and achievements. 
...
#### **1. US-01-Access the Platform** As a 
...
#### **2. US-04-Understand Alice and Bob** As 
...
#### **1. US-17-Create/Access an Account As a** 
...
#### **1. US-23-Complete a Daily Challenge As a** 
...
|DailyChallenges|US-23–US-26|FR-17–FR-18, LR-09–LR-10|
...
AI-generated code shall not be executed without an approved controlled execution pathway. **BR-11-** 
...
#### **Requirements affected:** FR-20–FR-21, 
...
#### **Observation 13-Quantum computing should not be presented simply as faster classical** 
...
FR-15–FR-23, LR-09–LR-14, UX-08–UX-12, US-20–US-31. 
