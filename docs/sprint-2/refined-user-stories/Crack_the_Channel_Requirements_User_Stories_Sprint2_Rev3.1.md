**Final Requirements & User Stories Baseline Revision: 3.0** 
...
|**Document Status**|<sup>Sprint 2: Final Requirements & User Stories Baseline</sup><br>Revision: 3.1|
|**Purpose**|This document establishes the refined requirements and user stories baseline<br>carried forward from Sprint 1 into Sprint 2, incorporating refined user<br>research, beginner-learning observations, UX findings, technical feasibility<br>work, IBM Quantum learning insights, and Product Owner/client direction.<br>The requirements identify the functionality and learning experience being<br>implemented and validated during Sprint 2|



# **1. Purpose of This Document** 

This document establishes the final Sprint 1 requirements and user stories baseline, incorporating beginner-learning observations, UX findings, technical feasibility work, learner research, IBM Quantum learning insights, and Product Owner/client direction. The finalised requirements identify the functionality and learning experience to be taken forward into Sprint 2. The requirements have been refined using: 
...
- technical feasibility discussions; and   the team's updated Sprint 2 development direction. 
...
These additional features were developed by the team in response to the client's direction to think creatively about learner engagement, together with learner research, IBM Quantum learning 

observations, and the team's analysis of how to support continued learning. They remain subordinate to the core educational objective and are prioritised as Should Have requirements where implementation feasibility is relevant. 
...
In addition, following Product Owner direction to explore ways of making the learning experience more engaging and encouraging continued use, the team developed an ongoing learning journey that provides meaningful reasons for learners to return and continue developing their knowledge. 
...
- understand the purpose of BB84;   learn the quantum concepts required to understand BB84; 
...
- points/XP for meaningful learning activities; 

- learning milestones; 

- badges/achievements for meaningful learning milestones; 
...
The finalised scope incorporates the team's refined direction around authentication, persistent progress, AI learning support, challenges and gamified progression. These additions extend the original BB84 learning objective and are prioritised according to their contribution to learning outcomes and implementation feasibility. 
...
# **3.3 Requirements Change Basis** 

The final requirements baseline was developed from the original project brief and subsequent project direction during Sprint 1. 

**Core requirements** are derived from the original brief, including the browser-based BB84 learning platform, executable Qiskit-based circuits, Alice/Bob interaction, Eve/eavesdropping mode, QBER/error-rate feedback, beginner-focused content, usability testing, and project documentation. 

**Refined requirements** were developed by the BA and team in response to learner research, IBM Quantum learning observations, UX findings, technical feasibility considerations, and Product Owner/client direction. 

**Client direction** included encouraging the team to think creatively about the learning experience and explore AI and mechanisms that provide meaningful reasons for learners to return. The team translated this direction into proposed AI learning support, Daily Quantum Challenges, progressive levels, XP, achievements/badges, milestone feedback, and continued learning. 

These team-developed features do not replace the original BB84 learning objective. They extend the learning journey and remain subject to the priorities and constraints defined in this document 
...
**Requirement:** The system shall present simulation results in a form that supports learner interpretation. 
...
- Progress is updated when a learner completes the defined learning stage/segment. 

- Progress is associated with the learner's account. 

- Progress is retained when the learner starts a new session. 

- The learner can resume from their previously recorded progress. 
...
The system shall provide structured learning content organised into manageable modules and segments that progressively develop the knowledge required for BB84. 
...
- Each module is divided into manageable segments. 

- Learners can navigate through segments in the intended learning sequence. 

- Concepts are introduced progressively. 

- Content connects to relevant learning activities. 
...
The AI solution should prioritise an appropriate open-source approach where technically and operationally feasible. If an external AI service is required, its use is subject to technical, infrastructure, cost, and approval considerations. The specific AI technology is an implementation decision and is not prescribed by this requirement. 
...
- Module completion can award defined XP where applicable. 

- Points are associated with meaningful learning actions. 

- XP awarded is recorded against the learner's progress 
...
The system should provide badges, achievements or milestones for meaningful learning 
...
- Module achievements have defined completion criteria. 

- A badge is awarded only when the associated criteria are satisfied. 

- A learner achieves module completion when they obtain at least 70% in the applicable assessment. 

- Earned achievements are retained in the learner profile. 

- Achievement criteria are understandable. 

- The learner receives clear confirmation when the badge is earned. 
...
The system should provide appropriate celebratory feedback when learners complete significant learning milestones. **Priority:** Should Have 
...
The system should provide continuing learning activities, visible progression and meaningful achievements that give learners meaningful reasons to return to the platform. 
...
## **FR-24 — Module Completion Assessment** 

The system shall provide an assessment at the end of each major learning module to allow learners to demonstrate their understanding of the module content. 

**Priority:** Should Have 

## **Acceptance Criteria:** 

- Each applicable major module has an associated assessment. 

- The assessment is available after the learner reaches the required module stage. 

- The assessment evaluates concepts introduced within that module. 

- The learner receives a result after submission. 

- The result can be used to determine whether the module completion criteria have been met. 
...
The platform should provide meaningful opportunities for learners to return, including continuing learning activities, Daily Challenges, progression goals and achievements. **Priority:** Should Have 
...
The interface shall minimise situations where a beginner can unintentionally perform an action without understanding its purpose. **UX-07-Accessibility** 

The UX/UI shall incorporate appropriate accessibility considerations for a university learning platform. Specific accessibility standards and test criteria should be confirmed with the UX team/Product Owner rather than assumed. 
...
Failure or unavailability of the AI service shall not prevent access to the core learning experience. **NFR-** 
...
## **4. US-09-Understand the Exchange Outcome** 
...
## **4.US-13-Understand the Security Meaning** 
...
## **Epic-10: Module Assessment:** 

**1. US-32 — Complete a Module Assessment** 

**As a** beginner learner 

**I want to** complete an assessment at the end of a learning module 

**So that** I can check my understanding and demonstrate that I am ready to progress. 

**Acceptance Criteria:** 

- The learner can access the assessment after completing the required module content. 

- Questions relate to concepts taught within the module. 

- The learner receives a result after submission. 

- The learner can attempt the assessment again if the required pass criterion is not achieved. 

- The agreed pass criterion is applied consistently. 

- Successful completion can contribute to the learner's progression and achievement. 
...
|UX|US-01–US-32|UX-01–UX-12|
|TechnicalQuality|Cross-cutting|NFR-01–NFR-12|
|Module Assessment|US-32|FR-24,BR-15,BR-16|
...
## **BR-15 — Module Assessment Threshold** 

A learner must achieve at least 70% in the applicable module assessment to satisfy the defined assessment requirement for earning the associated achievement. 

## **BR-16 — Assessment Attempts** 

Learners may make multiple attempts at a module assessment to support continued learning and progression. 
...
## **Requirements affected:** FR-14, LR- 
...
**Requirements affected:** FR-20–FR-21, LR- 
...
## **Requirements affected:** FR-04, LR- 
...
The platform should hide unnecessary implementation complexity while still providing genuine Qiskitbased interaction. 
...
## **Requirements affected:** FR-04, FR- 
...
## **Requirements affected:** FR-03, LO- 
...
**Preparation → Measurement → Basis reconciliation → Error estimation → Post-processing Learning implication:** 
...
## **Requirements affected:** FR-10, LR- 
...
## **12.5 Product Owner Direction - Continued Engagement** 

## **Observation 20 : Learning experience should support continued engagement** 

During Sprint 1 consultation, the Product Owner encouraged the team to think creatively about the learning experience and explore AI and mechanisms that could provide learners with meaningful reasons to return to the platform. 

## **Learning implication:** 

A learning platform can extend beyond a single BB84 simulation by providing continuing opportunities for practice, progression and support. 

## **BA implication:** 

The team developed AI learning support, Daily Quantum Challenges, progressive learning levels, XP, achievements/badges and milestone feedback as mechanisms to extend the learning journey while keeping BB84 learning as the core objective. 

**Requirements affected:** FR-15–FR-23, LR-09–LR-14, UX-08–UX-12, US-20–US-31. 

# **13. Requirements Change Log** 

**CR-01 — Learning Module Assessment & Progression Rules** 

**Source** : DEV implementation proposal and team discussion 

**Reason:** Refines the learning-module structure, assessment, persistent progress and achievement behaviour based on the agreed implementation approach. **Status:** Approved **Version** : 3.1 

**Affected Requirements** : FR-13, FR-14, FR-19, FR-20, FR-22, FR-24, LR-07, LR-12, LR-13, NFR11, NFR-12, US-32, and BR-15–BR-16. 

# **14. Technical architecture/design decision record** 

**TD-01 — Learning Content Publication State** 

Learning modules include a publication state so content under development is not exposed to learners until it is ready for release. 

## **TD-02 — Assessment Answer-Key Storage** 

Assessment answer keys will be stored separately from learner-facing assessment content to reduce the risk of exposing correct answers through the application's learner-facing data. 
